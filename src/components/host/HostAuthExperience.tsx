  ...
  const handleGoogleSignIn = async () => {
    try {
      toast({
        ...
        description: "Initiating Google Single Sign-On.",
      });
                  ...
                  <div className="w-full max-w-sm space-y-3 pt-2">
                    ...
                    <div className="pt-1">
                      <button
                        ...
                        className="w-full h-12 rounded-2xl bg-white hover:bg-white/95 text-slate-800 font-bold text-xs tracking-wide shadow-md shadow-black/10 hover:shadow-lg active:scale-[0.97] transition-[transform,background-color,box-shadow] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)] flex items-center justify-center gap-3 cursor-pointer"
                      >
